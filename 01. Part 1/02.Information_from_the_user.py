# -*- coding: utf-8 -*-
"""
Link: https://programming-26.mooc.fi/part-1/2-information-from-the-user
1. Information from the user

Input refers to any information a user gives to the program. Specifically, the 
Python command input reads in a line of input typed in by the user. It may also 
be used to display a message to the user, to prompt for specific input.

The following program reads in the name of the user with the input command. It 
then prints it out with the print command:
...
That means the execution of the program could also look like this:
    
    What is your name? Paula Programmer
    Hi there, Paula Programmer
    
The word name in this program is a variable. In the context of programming, a 
variable is a location for storing some value, such as a string or a number. 
This value can be used later, and it can also be changed. 

    Naming variables
   
In principle, variables can be named quite freely, within certain limits specified 
in the Python language.

It is a common international programming practice to name variables in English, 
but you may come across code where variables are named in other languages, such 
as the native language of the programmer. The name of the variable has no direct 
effect on its content, so the name, in that sense, does not matter. However, it 
can often be helpful in understanding how code functions if variables are named 
logically and in English.
...
An example of the how the program should function:
    ...
    What is your name? Paul
        ...
        Paul
"""
print("1. Programming Excercise: Name Twice")
print("\n")
...
Let's have a closer look at the way the print command is used above. Within the 
brackets of the command there is both text in quotation marks as well as variable
names which refer to input from the user. These have been combined with a + operator, 
which concatenates two strings into a single string.
...
Programming Excercise: Name and exclamation marks
    ...
    of the line, another between the two names and a third one at the end of the 
    line.
    ...
    The program should function as follows:
        ...
        !Paul!Paul!
"""
print("2.. Programming Excercise: Name and exclamation marks")
print("\n")
# Write your solution here
...
A program can ask for more than one input. Notice how below each input command 
stores the received value in a different variable.
...
If the same variable is used to store more than one input, each new value will 
replace the previous one. For example:
...
there is no way to access the first input value after it has been replaced by 
the second:
...
# Write your solution here
print("3A. Programming Excercise: user's name and address")
print("\n")
...
"""
3B. Here is a program which should ask for three utterances and print them out, 
like so:
...
"""
print("3B. Programming Excercise: Fix the code")
print("\n")
...
name and a year, which should be inserted into the printout.
    ...
    Mary is a valiant knight, born in the year 1572. One morning Mary woke up 
    to an awful racket: a dragon was approaching the village. Only Mary could 
    save the village's residents.
    
The story should change according to the input given by the user.
"""

print("3C. Programming Excercise: Story")
print("\n")
